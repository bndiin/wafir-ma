...
const SAMPLE_PROS: ProCardData[] = [
  ...
  {
    slug: "credit-du-maroc-casablanca",
    name: "Credit du Maroc - Agence Maarif",
    type: "Banque",
    specialties: ["Credit Immobilier", "Credit Consommation", "Credit Auto"],
    city: "Casablanca",
    rating: 4.3,
  ...
  {
    slug: "saham-assurance-marrakech",
    name: "Saham Assurance - Marrakech",
    type: "Assurance",
    specialties: ["Assurance Auto", "Assurance Vie", "Assurance Habitation"],
    city: "Marrakech",
    rating: 4.4,
    reviewCount: 58,
    responseTime: "Repond en 2h",
  ...
  {
    slug: "al-akhdar-bank-rabat",
    name: "Al Akhdar Bank - Rabat",
    type: "Banque Participative",
    specialties: ["Mourabaha", "Ijara"],
    city: "Rabat",
    rating: 4.2,
    reviewCount: 41,
    responseTime: "Repond en 3h",
  ...
  {
    slug: "atlanta-assurance-tanger",
    name: "Atlanta Assurance - Tanger",
    type: "Assurance",
    specialties: ["Assurance Auto", "Mutuelle Sante"],
    city: "Tanger",
    rating: 4.1,
    reviewCount: 47,
    responseTime: "Repond en 3h",
  ...
  {
    slug: "cfg-bank-casablanca",
    name: "CFG Bank - Casablanca",
    type: "Banque",
    specialties: ["Credit Immobilier", "Credit Consommation"],
    city: "Casablanca",
    rating: 4.5,
    reviewCount: 53,
    responseTime: "Repond en 1h",
  ...
  {
    slug: "zurich-assurance-casablanca",
    name: "Zurich Assurance Maroc",
    type: "Assurance",
    specialties: ["Assurance Vie", "Assurance Voyage", "Mutuelle Sante"],
    city: "Casablanca",
    rating: 4.6,
    reviewCount: 62,
    responseTime: "Repond en 2h",
  ...
  {
    slug: "umnia-bank-casablanca",
    name: "Umnia Bank - Finance Participative",
    type: "Banque Participative",
    specialties: ["Mourabaha", "Moucharaka"],
    city: "Casablanca",
    rating: 4.3,
    reviewCount: 45,
    responseTime: "Repond en 2h",
  ...
  {
    slug: "allianz-maroc-rabat",
    name: "Allianz Maroc - Rabat",
    type: "Assurance",
    specialties: ["Assurance Auto", "Assurance Habitation", "Assurance Vie"],
    city: "Rabat",
    rating: 4.4,
    reviewCount: 68,
    responseTime: "Repond en 1h",
