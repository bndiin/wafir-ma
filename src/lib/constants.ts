...
export const NAV_LINKS = {
  credit: [
    { slug: 'credit-immobilier', labelFr: 'Crédit Immobilier' },
    { slug: 'credit-consommation', labelFr: 'Crédit Consommation' },
    { slug: 'credit-auto', labelFr: 'Crédit Auto' },
    { slug: 'rachat-credit', labelFr: 'Rachat de Crédit' },
    { slug: 'mourabaha', labelFr: 'Mourabaha' },
  ],
  assurance: [
    { slug: 'assurance-auto', labelFr: 'Assurance Auto' },
    { slug: 'assurance-habitation', labelFr: 'Assurance Habitation' },
    { slug: 'mutuelle-sante', labelFr: 'Mutuelle Santé' },
    { slug: 'assurance-vie', labelFr: 'Assurance Vie' },
    { slug: 'assurance-voyage', labelFr: 'Assurance Voyage' },
  ],
  outils: [
    { slug: 'simulateur-credit-immobilier', labelFr: 'Simulateur Crédit Immo' },
    { slug: 'comparateur-assurance-auto', labelFr: 'Comparateur Assurance Auto' },
    { slug: 'calculateur-capacite-emprunt', labelFr: 'Capacité d\'Emprunt' },
    { slug: 'simulateur-credit-consommation', labelFr: 'Simulateur Crédit Conso' },
    { slug: 'simulateur-mourabaha', labelFr: 'Simulateur Mourabaha' },
    { slug: 'calculateur-frais-notaire', labelFr: 'Frais de Notaire' },
    { slug: 'simulateur-rachat-credit', labelFr: 'Rachat de Crédit' },
  ],
} as const;
